...
- [stablesats-rs : How it Works and How to Change It](stablesats_rust.md)
  ...
  - [How to Decouple the Galoy Backend](sats_rust/decoupling_user_trades.md)
    - [Pointing it at a new Bitcoin Wallet](sats_rust/bitcoin_wallet.md)
    - [Pointing the user-trades module at a new USD Target Liability](sats_rust/decoupling_user_trades.md)
